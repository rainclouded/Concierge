...
class IncidentReportFactory:
    ...
    def create_incident_report(incident_report_JSON : json) -> IncidentReport:
        required_keys = ["Id","severity","status","title","description","filing_person_id","reviewer_Id"]
        ...
        return IncidentReport(id = incident_report_JSON.id, severity = incident_report_JSON.severity, status = incident_report_JSON.status, title = incident_report_JSON.title, 
