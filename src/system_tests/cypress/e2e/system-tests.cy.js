...
describe("System tests", () => {
  ...
  it.skip("Test amenities end to end", () => {
    ...
    cy.get(".amenity-row-item").should(($items) => {
    ...
    admin_login();
    cy.get(".sidebar-item").contains("Amenities").click();
    //Add an amenity
    ...
    cy.get(".amenity-item").should(($items) => {
    ...
    //Edit an amenity
    cy.contains("th", "Bar").parents("tr").find("td").contains("Edit").click();
    ...
    admin_login();
    cy.get(".sidebar-item").contains("Amenities").click();
    cy.contains("th", "Test").parents("tr").find("td").contains("Edit").click();
    cy.get("#name").clear().type("Bar");
    cy.get("#description").clear().type("Serves alcohol and food");
    cy.get("#startTime").clear().type("02:00:00");
    cy.get("#endTime").clear().type("03:00:00");
  ...
  it("Test incident reports end to end", () => {
    ...
    cy.get(".sidebar-item")
      ...
      .click();
    getReportCard("To do ", "Room Maintenance Request").should("exist");
    getReportCard("In progress", "Lost Property").should("exist");
    getReportCard("Resolved", "Fire Alarm Malfunction").should("exist");
    getReportCard("Closed", "Food Poisoning Incident").should("exist");
    ...
    getReportCard("Resolved", "Fire Alarm Malfunction").should("exist");
    getReportCard("Closed", "Food Poisoning Incident").should("exist");
    getReportCard("To do ", "TestingIncidentCreation").should("exist");
    getReportCard("To do", "TestingIncidentCreationDescription")
      .parent()
      .find(".delete-report")
      .click();

    cy.contains("Are you sure?").should("exist"); // Verify the confirmation modal
    cy.contains("button", "Confirm").click(); // Confirm deletion
