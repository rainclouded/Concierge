namespace amenities_server.model
{
    public static class ResponseMessages
    {
        ...
        public const string CREATE_AMENITY_SUCCESS = "Amenity created successfully.";

        public const string UPDATE_AMENITY_SUCCESS = "Amenity was updated successfully.";

        public const string DELETE_AMENITY_SUCCESS = "Amenity deleted successfully.";
